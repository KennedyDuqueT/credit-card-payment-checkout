import { IsString, IsNumber, IsEmail, IsPositive, MinLength, MaxLength, Matches } from 'class-validator';
...
export class CreateTransactionDto {
  ...
  @IsString()
  @Matches(/^(20[2-9][0-9]|2[1-9][0-9][0-9])$/, { message: 'Expiry year must be 2024 or later' })
